...
- ConfigurePromotionalWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- ConfigurePromotionalWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- ConfigurePromotionalWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- ConfigurePromotionalWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
